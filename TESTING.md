...
-   #### Returning Visitor Goals  
    ...
    5. As a Returning Visitor, I want to be able to quickly and easily see where the creators skills and abilities lie within the field of web design find out what kind of programming 
       languages and frameworks that they have experience with.  
        1. The 'Currently' section on the home page informs the user with helpful graphs and images what languages the the creator is comfortable with.
        2. The 'Projects' section of the site has various links to projects that the creator has made, but also desciptions of the design process and purpose of the website, which offers further 
        insight into the creator's abilities.
        3. The 'Projects' section also contains a link to this website, indiciating to users that the very project they are currently accessing was built by the creator, though that information
        should be axoimatic to most users.
...
-   #### Frequent User Goals
    ...
    2. As a Frequent User, I want to easily check to see if there are any newly added postings to the Work History section or any other important updates to the creator's employment status.
        1. The user would already be comfortable with the website layout and can easily click the the 'Work History' button from anywhere on the website due to the sticky navigation bar.
...
-   On Chrome for Android & Desktop, the default zoom of some of the web pages will change from 100% to much larger, which will initiate a horizontal scroll bar and not fit the website 
    ...
    100% so the broswer shouldn't zoom in an inappropriate amount. 
    - The above fix seems to have solved the issue. However, the inconsistent nature of this bug only appearing sometimes makes further quite difficult.
...
- **Footer Displacement**
  ...
  4. I didn't want to include a sticky footer, as I had alreay included a sticky navigation bar in the header, and having both stick to the screen at the same time would take up valuable screen
  ...
  [ccs tricks and can be found here.](https://css-tricks.com/couple-takes-sticky-footer/)
...
- **Grid System Issue**
  ...
  above.
  3. I must admit, why exactly this occured, is somewhat beyond me. I'm not super familiar with the grid system, and didn't have the time to look into it in great detail unfortunately.
  ...
  5. On larger screens however, at higher resolutions there would be a vary large gap between the navigation bar and the beginning of the content, and so extra margin-bottom declarations had to be
...
- **Newsletter List Issues**
  ...
  2. This one gave me a real headache. No matter what I tried or how many various types of containers I coudn't find a way to bring the bulletpoints for the list next to the actual list items,
  while still keeping the list text centered in a sensible way.
